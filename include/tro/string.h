...
TRO__API bool tro_vsfmt16(tro_dybuffer_obj buf, const char16_t *format,
                          va_list args);
...
TRO__API char *tro_str_fmt16(size_t *outlen, const char16_t *format, ...);

TRO__API char *tro_vstr_fmt16(size_t *outlen, const char16_t *format,
                              va_list args);

TRO__API char16_t *tro_str16_fmt(size_t *outlen, const char *format, ...);

TRO__API char16_t *tro_vstr16_fmt(size_t *outlen, const char *format,
                                  va_list args);

TRO__API char16_t *tro_str16_fmt16(size_t *outlen, const char16_t *format, ...);

TRO__API char16_t *tro_vstr16_fmt16(size_t *outlen, const char16_t *format,
                                    va_list args);
