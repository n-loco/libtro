...
static inline size_t tro_float2str16(double num, tro_char16 *out, size_t outcap)
{
...
static inline size_t tro_float2str16_E(double num, tro_char16 *out,
                                       size_t outcap)
{
	TRO__API size_t tro__float2str16_eE(double num, tro_char16 *out,
                                             ...
                                             tro_char16 *out, size_t outcap)
{
	TRO__API size_t tro__float2str16_fixed_eE(
	    double num, uint32_t precision, tro_char16 *out, size_t outcap,
	    bool capital_e);
